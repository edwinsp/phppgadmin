<?php
	...
	$conf['servers'][0]['host'] = 'https://postgresql-prypostgres.7e14.starter-us-west-2.openshiftapps.com/';
	...
	$conf['servers'][1]['desc'] = 'PostgreSQL_local';
